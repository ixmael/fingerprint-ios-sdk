#
#  Be sure to run `pod spec lint Fingerprint.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  Fingerprint library to detect the device fingerprint. This is for ios devices.
                   DESC
  ...
  spec.author             = { "ixmael" => "hola@irm.mx" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "" }
  ...
  spec.source       = { :git => "https://github.com/ixmael/fingerprint-ios-sdk.git", :tag => "#{spec.version}" }
